                    ...
                    <table>
                        ...
                        <tr>
                            <td colspan="2">
                                <table>
                                    <tr>
                                        <td width="199"><?php avala_field('currently_own', '', false, 'all', '', 'select', 'Have you ever owned a hot tub?'); ?></td>
                                        <td width="199"><?php avala_field('buy_time_frame', '', false, 'all', '', 'select'); ?></td>
