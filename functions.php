...
function change_countries2($countries)
    {
        return array( 
			...
			"CC" => __('Cocos (Keeling) Islands', 'gravityforms'),
			"CD" => __('Congo, the Democratic Republic of the', 'gravityforms'),
			"CF" => __('Central African Republic', 'gravityforms'),
			"CG" => __('Congo', 'gravityforms'),
			"CH" => __('Switzerland', 'gravityforms'),
			"CI" => __('Cote d’Ivoire', 'gravityforms'),
			...
			"FK" => __('Falkland Islands (Malvinas)', 'gravityforms'),
			...
			"GS" => __('South Georgia and the South Sandwich Islands', 'gravityforms'),
			...
			"LY" => __('Libyan Arab Jamahiriya', 'gravityforms'),
			"MA" => __('Morocco', 'gravityforms'),
			"MC" => __('Monaco', 'gravityforms'),
			"MD" => __('Moldova, Republic of', 'gravityforms'),
			"ME" => __('Montenegro', 'gravityforms'),
			"MF" => __('Saint Martin (French part)', 'gravityforms'),
			"MG" => __('Madagascar', 'gravityforms'),
			"MK" => __('Macedonia, the former Yugoslav Republic of', 'gravityforms'),
			...
			"SX" => __('Sint Maarten (Dutch part)', 'gravityforms'),
			"SY" => __('Syrian Arab Republic', 'gravityforms'),
			"SZ" => __('Swaziland', 'gravityforms'),
