...
// Iframe Color Selector For Sundance - German
...
<div class="color-selector color-selector-container">
	...
	<div class="color-selector-wrapper">
		...
		<div class="right">
			...
			<h2><strong>SCHALENFARBE:</strong> <span class="shell-name"></span></h2>
			<div class="shells">
				<div class="shell thumb active" timg="celestite" data-pdf="celestite" rel="Perlmutt" ><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/colorselector/shells/celestite-thumb.jpg" height="50" width="50"/></div>
...
jQuery(function($){
	...
	function updatepdf() {
		var pdf1 = $('.color-selector div.shell.thumb.active').attr('data-pdf'),
			...
			pdfroot = "<?php echo get_stylesheet_directory_uri().'/brochures/shellskirtoptions/ger/'; ?>";
